<template>
  <div class="font-sans margin">
    <div
      class="relative min-h-screen flex flex-col sm:justify-center items-center bg-gray-100"
    >
      <div class="relative sm:max-w-sm w-full">
        <div
          class="card bg-yellow-500 shadow-lg w-full h-full rounded-3xl absolute transform -rotate-6"
        ></div>
        <div
          class="card bg-gray-900 shadow-lg w-full h-full rounded-3xl absolute transform rotate-6"
        ></div>
        <div
        ...
        >
          ...
          <form method="#" action="#" class="mt-10">
            ...
            <div class="mt-7">
              <button
                class="bg-black w-full py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105"
              >
                Registrar
              </button>
            </div>
